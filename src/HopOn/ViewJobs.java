...
/*                Query = " SELECT a.RegistrationNum,a.ChesisNo,a.CustName,DATE_FORMAT(a.AssignDate,'%Y-%m-%d %H:%i:%s') ,a.Make,a.Model,\n" +
                ...
                Query = " SELECT a.RegistrationNum,a.ChesisNo,a.CustName,DATE_FORMAT(a.AssignDate,'%Y-%m-%d %H:%i:%s') ,a.Make,a.Model,\n" +
                        ...
                        "\t\t\tWHEN b.Distance IS NOT NULL AND b.TransferFlag = 1 THEN 'Transfer'\n" +
                        "ELSE b.Distance \n" +
                        "END,CONCAT(a.ScheduledDate,' ',a.ScheduledTime) \n" +
                        "FROM CustomerData a\n" +
            ...
            while (rset.next()) {
                ...
                if (rset.getString(14).equals("Job Completed")) {
                    ...
                    // AssignedJobs.append("<td align='left' data-container='body' data-toggle='tooltip' data-placement='left' title= 'Click to Find Complain Location' ><a href = \"/HopOn/HopOn.ComplainLocation?Action=ViewLocationReport&Flag=1&ComplainNumber=" + ReplaceComplainNumber + " target=\"_self\"> " + rset.getString(15) + " </a></td>");
                    ...
                    AssignedJobs.append("<td bgcolor=#A2DA62 align='left' data-container='body' data-toggle='tooltip' data-placement='left' title= 'Click to Find Technician Location' ><a href = \"/HopOn/HopOn.ManualAssignment?ActionID=GetTechLocation&TechId=" + rset.getString(13) + " \" target=\"_self\"> <small>" + rset.getString(12) + "</small> </a></td>");
                    AssignedJobs.append("<td bgcolor=#A2DA62 align=center><a class=\"btn-sm btn btn-info\" href=/" + (ServerIndex == 1 ? "HopOn" : "TAMAPPTesting") + "/HopOn.ComplainLocation?Action=ViewLocationReport&Flag=1&ComplainNumber=" + ReplaceComplainNumber + " target=NewFrame1><i class=\"fa fa-edit\"></i> [ View ] </a></td>");
                    ...
                    AssignedJobs.append("<td bgcolor=#A2DA62 align=left>" + rset.getString(20) + "</td>\n");// ScheduledDate
                    AssignedJobs.append("</tr>");
                } else {
                    AssignedJobs.append("<tr>");
                    ...
                    AssignedJobs.append("<td align='left' data-container='body' data-toggle='tooltip' data-placement='left' title= 'Click to Find Technician Location' ><a href = \"/HopOn/HopOn.ManualAssignment?ActionID=GetTechLocation&TechId=" + rset.getString(13) + " \" target=\"_self\"> <small>" + rset.getString(12) + "</small> </a></td>");
                    AssignedJobs.append("<td align=center><a class=\"btn-sm btn btn-info\" href=/" + (ServerIndex == 1 ? "HopOn" : "TAMAPPTesting") + "/HopOn.ComplainLocation?Action=ViewLocationReport&Flag=1&ComplainNumber=" + ReplaceComplainNumber + " target=NewFrame1><i class=\"fa fa-edit\"></i> [ View ] </a></td>");
            ...
            while (rset.next()) {
                ...
                UnAssignedJobs.append("<td align=center><a class=\"btn-sm btn btn-info\" href=/" + (ServerIndex == 1 ? "HopOn" : "TAMAPPTesting") + "/HopOn.ComplainLocation?Action=ViewLocationReport&Flag=1&ComplainNumber=" + ReplaceComplainNumber + " target=NewFrame1><i class=\"fa fa-edit\"></i> [ View ] </a></td>");
...
//                    " ORDER BY a.AssignDate DESC ";
            ...
            while (rset.next()) {
                ...
                PostponedJobs.append("<td align='left' data-container='body' data-toggle='tooltip' data-placement='left' title= 'Click to Find Technician Location' ><a href = \"/HopOn/HopOn.ManualAssignment?ActionID=GetTechLocation&TechId=" + rset.getString(13) + " \" target=\"_self\"> <small>" + rset.getString(12) + "</small> </a></td>");
                PostponedJobs.append("<td align=center><a class=\"btn-sm btn btn-info\" href=/" + (ServerIndex == 1 ? "HopOn" : "TAMAPPTesting") + "/HopOn.ComplainLocation?Action=ViewLocationReport&Flag=1&ComplainNumber=" + ReplaceComplainNumber + " target=NewFrame1><i class=\"fa fa-edit\"></i> [ View ] </a></td>");
                // PostponedJobs.append("<td align=center><a class=\"btn-sm btn btn-info\" href=/HopOn/HopOn.ViewJobs?Action=CreateHistory&Id=" + rset.getString(18) + "&UserName=" + rset.getString(19) + " target=NewFrame1><i class=\"fa fa-edit\"></i> [ ReAlive ] </a></td>");
                PostponedJobs.append("<td align=left>" + rset.getString(20) + "</td>\n");// Address
                PostponedJobs.append("<td align=left>" + rset.getString(21) + "</td>\n");// Postponed Reason
                PostponedJobs.append("</tr>");
...
/*                Query = "SELECT a.RegistrationNum,a.ChesisNo,a.CustName,DATE_FORMAT(a.AssignDate,'%Y-%m-%d %H:%i:%s'),a.Make,a.Model,  "
            ...
            while (rset.next()) {
                ...
                CancelledJobs.append("<td align=center><a class=\"btn-sm btn btn-info\" href=/" + (ServerIndex == 1 ? "HopOn" : "TAMAPPTesting") + "/HopOn.ComplainLocation?Action=ViewLocationReport&Flag=1&ComplainNumber=" + ReplaceComplainNumber + " target=NewFrame1><i class=\"fa fa-edit\"></i> [ View ] </a></td>");
                ...
                CancelledJobs.append("<td align='left' data-container='body' data-toggle='tooltip' data-placement='left' title= 'Click to Find Technician Location' ><a href = \"/HopOn/HopOn.ManualAssignment?ActionID=GetTechLocation&TechId=" + rset.getString(13) + " \" target=\"_self\"> <small>" + rset.getString(12) + "</small> </a></td>");
                CancelledJobs.append("<td align=center><a class=\"btn-sm btn btn-info\" href=/" + (ServerIndex == 1 ? "HopOn" : "TAMAPPTesting") + "/HopOn.ViewJobs?Action=CreateHistory&Id=" + rset.getString(16) + "&UserName=" + rset.getString(12) + " target=NewFrame1><i class=\"fa fa-edit\"></i> [ ReAlive ] </a></td>");
                CancelledJobs.append("<td align=left>" + rset.getString(19) + "</td>\n");//Address
                CancelledJobs.append("<td align=left>" + rset.getString(20) + "</td>\n");//CancelledRemarks
                CancelledJobs.append("</tr>");
            }
            rset.close();
            stmt.close();
