...
//        request.setCharacterEncoding("UTF-8");
        ...
        try {
            ...
            try {
                ...
                if (conn == null) {
                    ...
                    Parser.GenerateHtml(writer, String.valueOf(Supportive.GetHtmlPath(this.getServletContext())) + "index.html");
                    return;
                }
            ...
            int UserId = Integer.parseInt(request.getParameter("UserIndex").trim());
            int CityIndex = Integer.parseInt(request.getParameter("CityIndex").trim());
            int isAdmin = Integer.parseInt(request.getParameter("AdminCheck").trim());
            if (ActionID.equals("GetAction")) {
                ResponseDisplay(request, writer, conn, UserId, CityIndex, isAdmin);
            }
    ...
    private void ResponseDisplay(HttpServletRequest request, PrintWriter writer, Connection conn, int UserId, int CityIndex, int isAdmin) {
        ...
        try {
            ...
            try {
                ...
                rset1.close();
                cStmt.close();
                //writer.write("IN METHOD AA " + Online + " ___ " + LogOut + "___________" + 0 + "_______" + 00 + "_______" + UnAssignedJobs + "_________" + Offline);
                ...
                TotalTechStatus.append("<th>Drivers</th>");
                ...
                TotalTechStatus.append("<th><span class=\"label label-info\">Driver Status</span></th>");
                ...
                while (rset1.next()) {
                    ...
                    if (Difference < 46 && CurrDateCheck == 1) {
                        TotalTechStatus.append("<td  bgcolor=#befca4 align='left' data-container='body' data-toggle='tooltip' data-placement='left' title= 'Click to Find Driver Location' ><a href = \"/" + (ServerIndex == 1 ? "HopOn" : "TAMAPPTesting") + "/HopOn.ManualAssignment?ActionID=GetTechLocation&TechId=" + TechId + " \" target=\"_self\"> <small>" + TechName + "</small> </a></td>");
                        ...
                        if (LoginCount == 0)
                            TotalTechStatus.append("<td bgcolor=#befca4 class=\"text-center \"><img src=/" + (ServerIndex == 1 ? "HopOn" : "TAMAPPTesting") + "/images/OfflineImage.png width=20 height=10 ><br></td>");// Status
                        else
                            TotalTechStatus.append("<td bgcolor=#befca4 class=\"text-center \" ><img src=/" + (ServerIndex == 1 ? "HopOn" : "TAMAPPTesting") + "/images/OnlineImage.png width=20 height=10 ><br></td>");// Status
                    ...
                    //Greater than 45 min and current date
                        ...
                        TotalTechStatus.append("<td bgcolor=#fafca4 align='left' data-container='body' data-toggle='tooltip' data-placement='left' title= 'Click to Find Driver Location' ><a href = \"/" + (ServerIndex == 1 ? "HopOn" : "TAMAPPTesting") + "/HopOn.ManualAssignment?ActionID=GetTechLocation&TechId=" + TechId + " \" target=\"_self\"> <small>" + TechName + "</small> </a></td>");
                        ...
                        if (LoginCount == 0)
                            TotalTechStatus.append("<td bgcolor=#fafca4 class=\"text-center \"><img src=/" + (ServerIndex == 1 ? "HopOn" : "TAMAPPTesting") + "/images/OfflineImage.png width=20 height=10 ><br></td>");// Status
                        else
                            TotalTechStatus.append("<td bgcolor=#fafca4 class=\"text-center \" ><img src=/" + (ServerIndex == 1 ? "HopOn" : "TAMAPPTesting") + "/images/OnlineImage.png width=20 height=10 ><br></td>");// Status

                        TotalTechStatus.append("<td bgcolor=#fafca4 class=\"text-center small\" >" + TechnicianLocationDate + "</span></td>");
                    }
                    //Less then Curr Date
                    else {
                        TotalTechStatus.append("<td bgcolor=#f47a7a align='left' data-container='body' data-toggle='tooltip' data-placement='left' title= 'Click to Find Driver Location' ><a href = \"/" + (ServerIndex == 1 ? "HopOn" : "TAMPAPPTesting") + "/HopOn.ManualAssignment?ActionID=GetTechLocation&TechId=" + TechId + " \" target=\"_self\"> <small>" + TechName + "</small> </a></td>");
                        ...
                        if (LoginCount == 0)
                            TotalTechStatus.append("<td bgcolor=#f47a7a class=\"text-center \"><img src=/" + (ServerIndex == 1 ? "HopOn" : "TAMAPPTesting") + "/images/OfflineImage.png width=20 height=10 ><br></td>");// Status
                        else
                            TotalTechStatus.append("<td bgcolor=#f47a7a class=\"text-center \" ><img src=/" + (ServerIndex == 1 ? "HopOn" : "TAMAPPTesting") + "/images/OnlineImage.png width=20 height=10 ><br></td>");// Status
...
/*                    //within 45 min and current date
                    if (Difference < 46 && CurrDateCheck == 1) {
                        TotalTechStatus.append("<tr>");
                        TotalTechStatus.append("<td bgcolor=#befca4 align='left' data-container='body' data-toggle='tooltip' data-placement='left' title= 'Click to Find Technician Location' ><a href = \"/HopOn/HopOn.ManualAssignment?ActionID=GetTechLocation&TechId=" + TechId + " \" target=\"_self\"> <small>" + TechName + "</small> </a></td>");
                        ...
                        TotalTechStatus.append("<td bgcolor=#befca4 class=\"text-center medium\" ><span class=\"label label-danger\">" + TCanceled + "</span></td>");
                        if (LoginCount == 0)
                            TotalTechStatus.append("<td bgcolor=#befca4 class=\"text-center \"><img src=/HopOn/images/OfflineImage.png width=20 height=10 ><br></td>");// Status
                        else
                            TotalTechStatus.append("<td bgcolor=#befca4 class=\"text-center \" ><img src=/HopOn/images/OnlineImage.png width=20 height=10 ><br></td>");// Status
                    ...
                    //Greater than 45 min and current date
                        ...
                        TotalTechStatus.append("<tr>");
                        TotalTechStatus.append("<td bgcolor=#fafca4 align='left' data-container='body' data-toggle='tooltip' data-placement='left' title= 'Click to Find Technician Location' ><a href = \"/HopOn/HopOn.ManualAssignment?ActionID=GetTechLocation&TechId=" + TechId + " \" target=\"_self\"> <small>" + TechName + "</small> </a></td>");
                        ...
                        TotalTechStatus.append("<td bgcolor=#fafca4 class=\"text-center medium\" ><span class=\"label label-danger\">" + TCanceled + "</span></td>");
                        if (LoginCount == 0)
                            TotalTechStatus.append("<td bgcolor=#fafca4 class=\"text-center \"><img src=/HopOn/images/OfflineImage.png width=20 height=10 ><br></td>");// Status
                        else
                            TotalTechStatus.append("<td bgcolor=#fafca4 class=\"text-center \" ><img src=/HopOn/images/OnlineImage.png width=20 height=10 ><br></td>");// Status
                    ...
                    //Less then Curr Date
                        ...
                        TotalTechStatus.append("<tr>");
                        TotalTechStatus.append("<td bgcolor=#f47a7a align='left' data-container='body' data-toggle='tooltip' data-placement='left' title= 'Click to Find Technician Location' ><a href = \"/HopOn/HopOn.ManualAssignment?ActionID=GetTechLocation&TechId=" + TechId + " \" target=\"_self\"> <small>" + TechName + "</small> </a></td>");
                        ...
                        TotalTechStatus.append("<td bgcolor=#f47a7a class=\"text-center medium\" ><span class=\"label label-danger\">" + TCanceled + "</span></td>");
                        if (LoginCount == 0)
                            TotalTechStatus.append("<td bgcolor=#f47a7a class=\"text-center \"><img src=/HopOn/images/OfflineImage.png width=20 height=10 ><br></td>");// Status
                        else
                            TotalTechStatus.append("<td bgcolor=#f47a7a class=\"text-center \" ><img src=/HopOn/images/OnlineImage.png width=20 height=10 ><br></td>");// Status
                ...
                //writer.write("data: " + Online + "|" + LogOut + "|" + Offline + "|" + UnAssignedJobs + "|" + AssignedJobs + "|" + TotalTech + "|" + TotalTechStatus.toString() + "|" + ParamCheck);
