    ...
    private void ViewJobs(HttpServletRequest request, HttpServletResponse response, PrintWriter out, Connection conn, ServletContext servletContext) {
        ...
        try {
            ...
            while (rset.next()) {
                ...
                ViewAllJobs.append("<td align=center><a class=\"btn-sm btn btn-info\" href=/" + (ServerIndex == 1 ? "HopOn" : "TAMAPPTesting") + "/HopOn.ComplainLocation?Action=ViewLocationReport&Flag=1&ComplainNumber=" + ReplaceComplainNumber + " target=NewFrame1><i class=\"fa fa-edit\"></i> [ View ] </a></td>");
