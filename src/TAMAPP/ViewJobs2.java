    ...
    private void WLF_ShowJobs(HttpServletRequest request, HttpServletResponse response, PrintWriter out, Connection conn, ServletContext servletContext) {
        ...
        if (!SecurityToken.equals("FSkrs4ksdk4kpew2123mFdFeqertQ*53jj$0kmqzRdzwq")) {
            try {
                ...
                Parser.SetField("FormName", "ViewJobs2");
                Parser.SetField("ActionID", "WLF_ShowJobs");
                Parser.SetField("Message", "Please do not change Security Token!! Please use provided token");
                Parser.GenerateHtml(out, Supportive.GetHtmlPath(servletContext) + "Exceptions/Message.html");
            } catch (Exception e) {
                out.println("Error3" + e.getMessage());
            }
...
//                    " ORDER BY a.AssignDate DESC ";
            ...
            while (rset.next()) {
                ...
                if (rset.getString(14).equals("Job Completed")) {
                    ...
                    // AJs.append("<td align='left' data-container='body' data-toggle='tooltip' data-placement='left' title= 'Click to Find Complain Location' ><a href = \"/TAMAPP/TAMAPP.ComplainLocation?Action=ViewLocationReport&Flag=1&ComplainNumber=" + ReplaceComplainNumber + " target=\"_self\"> " + rset.getString(15) + " </a></td>");
                    ...
                    AJs.append("<td bgcolor=#A2DA62 align='left' data-container='body' data-toggle='tooltip' data-placement='left' title= 'Click to Find Technician Location' ><a href = \"/TAMAPP/TAMAPP.ViewJobs2?Action=GetTechLocation&TechId=" + rset.getString(13) + " \" target=\"_self\"> <small>" + rset.getString(12) + "</small> </a></td>");
                    AJs.append("<td bgcolor=#A2DA62 align=center><a class=\"btn-sm btn btn-info\" href=/TAMAPP/TAMAPP.ViewJobs2?Action=LocationJobs&Flag=1&ComplainNumber=" + ReplaceComplainNumber + " target=NewFrame1><i class=\"fa fa-edit\"></i> [ View ] </a></td>");
                    ...
                    AJs.append("<td align='left' data-container='body' data-toggle='tooltip' data-placement='left' title= 'Click to Find Technician Location' ><a href = \"/TAMAPP/TAMAPP.ViewJobs2?Action=GetTechLocation&TechId=" + rset.getString(13) + " \" target=\"_self\"> <small>" + rset.getString(12) + "</small> </a></td>");
                    AJs.append("<td align=center><a class=\"btn-sm btn btn-info\" href=/TAMAPP/TAMAPP.ViewJobs2?Action=LocationJobs&Flag=1&ComplainNumber=" + ReplaceComplainNumber + " target=NewFrame1><i class=\"fa fa-edit\"></i> [ View ] </a></td>");
...
//                    " ORDER BY a.CreatedDate DESC";
            ...
            while (rset.next()) {
                ...
                UAJs.append("<td align=center><a class=\"btn-sm btn btn-info\" href=/TAMAPP/TAMAPP.ViewJobs2?Action=LocationJobs&Flag=1&ComplainNumber=" + ReplaceComplainNumber + " target=NewFrame1><i class=\"fa fa-edit\"></i> [ View ] </a></td>");
...
//                    " ORDER BY a.AssignDate DESC ";
            ...
            while (rset.next()) {
                ...
                PJs.append("<td align='left' data-container='body' data-toggle='tooltip' data-placement='left' title= 'Click to Find Technician Location' ><a href = \"/TAMAPP/TAMAPP.ViewJobs2?Action=GetTechLocation&TechId=" + rset.getString(13) + " \" target=\"_self\"> <small>" + rset.getString(12) + "</small> </a></td>");
                PJs.append("<td align=center><a class=\"btn-sm btn btn-info\" href=/TAMAPP/TAMAPP.ViewJobs2?Action=LocationJobs&Flag=1&ComplainNumber=" + ReplaceComplainNumber + " target=NewFrame1><i class=\"fa fa-edit\"></i> [ View ] </a></td>");
...
/*            Query = "SELECT a.RegistrationNum,a.ChesisNo,a.CustName,a.AssignDate,a.Make,a.Model,  "
            ...
            while (rset.next()) {
                ...
                CJs.append("<td align=center><a class=\"btn-sm btn btn-info\" href=/TAMAPP/TAMAPP.ViewJobs2?Action=LocationJobs&Flag=1&ComplainNumber=" + ReplaceComplainNumber + " target=NewFrame1><i class=\"fa fa-edit\"></i> [ View ] </a></td>");
                ...
                CJs.append("<td align='left' data-container='body' data-toggle='tooltip' data-placement='left' title= 'Click to Find Technician Location' ><a href = \"/TAMAPP/TAMAPP.ViewJobs2?Action=GetTechLocation&TechId=" + rset.getString(13) + " \" target=\"_self\"> <small>" + rset.getString(12) + "</small> </a></td>");
