    ...
    private void GETSTATES(HttpServletRequest request, PrintWriter out, Connection conn, ServletContext servletContext, String UserId) {
        ...
        try {
            ...
            while (rset.next()) {
                ...
                if (LoginCount == 0)
                    TechnicianList.append("<td><img src=/TAMAPP/images/OfflineImage.png width=30 height=20 ><br></td>");// Status
                else
                    TechnicianList.append("<td><img src=/TAMAPP/images/OnlineImage.png width=30 height=20 ><br></td>");// Status
