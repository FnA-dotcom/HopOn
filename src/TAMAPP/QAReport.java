...
/*            Query = "SELECT Pic1,Pic2,Pic3,Pic4 " +
            ...
            while (rset.next()) {
                ...
                if (!rset.getString(1).equals("-"))
                    ImageList.append("<td align=left> <a href=\"JavaScript:newPopup('/TAMAPP/TAMAPP.QAReport?ActionID=ViewImage&FileName=" + rset.getString(1) + "');\"><i class=\"fa fa-share\">[View]</i></a></td>\n");// Shop Pic
                else
                    ImageList.append("<td align=left>No Image Taken</td>\n");
                if (!rset.getString(2).equals("-"))
                    ImageList.append("<td align=left> <a href=\"JavaScript:newPopup('/TAMAPP/TAMAPP.QAReport?ActionID=ViewImage&FileName=" + rset.getString(2) + "');\"><i class=\"fa fa-share\">[View]</i></a></td>\n");// Shop Pic
                else
                    ImageList.append("<td align=left>No Image Taken</td>\n");
                if (!rset.getString(3).equals("-"))
                    ImageList.append("<td align=left> <a href=\"JavaScript:newPopup('/TAMAPP/TAMAPP.QAReport?ActionID=ViewImage&FileName=" + rset.getString(3) + "');\"><i class=\"fa fa-share\">[View]</i></a></td>\n");// Shop Pic
                else
                    ImageList.append("<td align=left>No Image Taken</td>\n");
                if (!rset.getString(4).equals("-"))
                    ImageList.append("<td align=left> <a href=\"JavaScript:newPopup('/TAMAPP/TAMAPP.QAReport?ActionID=ViewImage&FileName=" + rset.getString(4) + "');\"><i class=\"fa fa-share\">[View]</i></a></td>\n");// Shop Pic
                else
                    ImageList.append("<td align=left>No Image Taken</td>\n");
                ImageList.append("</tr>");
            }
