...
/*            AuthorizeUser authent = new AuthorizeUser(conn);
            ...
            if (Action.equals("GETINPUT")) {
                InputReport(request, response, out, conn, context);
    ...
    private void InputReport(HttpServletRequest request, HttpServletResponse response, PrintWriter out, Connection conn, ServletContext servletContext) {
        stmt = null;
        rset = null;
        Query = "";
...
/*            Query = "SELECT Pic1,Pic2,Pic3,Pic4 " +
            ...
            while (rset.next()) {
                ...
                if (!rset.getString(1).equals("-"))
                    ImageList.append("<td align=left> <a href=\"JavaScript:newPopup('/TAMAPP/TAMAPP.InspectionReport?ActionID=ViewImage&FileName=" + rset.getString(1) + "');\"><i class=\"fa fa-share\">[View]</i></a></td>\n");// Shop Pic
                else
                    ImageList.append("<td align=left>No Image Taken</td>\n");
                if (!rset.getString(2).equals("-"))
                    ImageList.append("<td align=left> <a href=\"JavaScript:newPopup('/TAMAPP/TAMAPP.InspectionReport?ActionID=ViewImage&FileName=" + rset.getString(2) + "');\"><i class=\"fa fa-share\">[View]</i></a></td>\n");// Shop Pic
                else
                    ImageList.append("<td align=left>No Image Taken</td>\n");
                if (!rset.getString(3).equals("-"))
                    ImageList.append("<td align=left> <a href=\"JavaScript:newPopup('/TAMAPP/TAMAPP.InspectionReport?ActionID=ViewImage&FileName=" + rset.getString(3) + "');\"><i class=\"fa fa-share\">[View]</i></a></td>\n");// Shop Pic
                else
                    ImageList.append("<td align=left>No Image Taken</td>\n");
                if (!rset.getString(4).equals("-"))
                    ImageList.append("<td align=left> <a href=\"JavaScript:newPopup('/TAMAPP/TAMAPP.InspectionReport?ActionID=ViewImage&FileName=" + rset.getString(4) + "');\"><i class=\"fa fa-share\">[View]</i></a></td>\n");// Shop Pic
                else
                    ImageList.append("<td align=left>No Image Taken</td>\n");
                ImageList.append("</tr>");
            }
    ...
    private void ViewImage(HttpServletRequest request, HttpServletResponse response, PrintWriter out) {
        ...
        try {
            ...
            String path = "/opt/Htmls/TAMAPP/pics/" + FileName;
            out.println(path);
