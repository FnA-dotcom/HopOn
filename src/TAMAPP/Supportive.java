...
//	}
    public String GetConnectString() {
        ...
        //Testing IP
        //return "jdbc:mysql://203.130.0.239/FalconTesting?user=tabish&password=tpassword";
    ...
    public static boolean checkSession(PrintWriter out, HttpServletRequest request) {
        if (request.getSession(false) == null) {
            out.println(" <center><table cellpadding=3 cellspacing=2><tr><td bgcolor=\"#FFFFFF\"> " +
                    ...
                    " </td></tr></table> " +
                    " <p> " +
                    " <font face=arial size=+1><b><a href=/TAMAPP/index.html target=_top> Return to Login " +
                    " </a></b></font>" +
